...
export const CapturedPieces: React.FC<CapturedPiecesProps> = ({
  ...
  return (
    <div className="flex items-center gap-1.5 min-h-[32px] px-2.5 py-1 rounded-xl bg-[#18110b]/70 border border-amber-900/40">
      <div className="flex items-center -space-x-1.5 sm:-space-x-2">
        {sortedPieces.length === 0 ? (
          ...
          sortedPieces.map((p, idx) => (
            <div key={`${p}-${idx}`} className="w-5 h-5 sm:w-6 sm:h-6 flex items-center justify-center shrink-0">
